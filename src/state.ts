...
/** Default friendly label for the panel at position `index` ("Panel 1",
 *  "Panel 2", …). The customer is encouraged to rename — this just makes
 *  the field's editable nature obvious from first paint instead of
